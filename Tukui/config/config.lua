...
TukuiCF["raidframes"] = {
	...
	["gridonly"] = true,                  -- enable grid only mode for all raid layout. TEMP
...
TukuiCF["auras"] = {
	...
	["playtarbuffperrow"] = 12,				-- buffs/debuffs per row on player/target frames
...
TukuiCF["actionbar"] = {
	["enable"] = true,                     -- enable tukz action bars
		...
		["bottomrows"] = 2,                    -- numbers of row you want to show at the bottom (select between 1, 1.5, 2, and 3 only(3 bars not compatible with split bar option))
...
TukuiCF["datatext"] = {
	...
	["currency"] = 5,						-- show watched items in backpack
...
TukuiCF["broker_datatext"] = { 		--/showldb for names
	["Outfitter"] = 3,
	["|cFFFFB366Ara|r Guild"] = 1,
}
